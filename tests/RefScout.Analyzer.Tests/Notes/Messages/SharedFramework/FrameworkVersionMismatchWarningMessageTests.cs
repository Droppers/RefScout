...
public class FrameworkVersionMismatchWarningMessageTests
{
    private readonly IContext _context;
    private readonly Message _generator;

    public FrameworkVersionMismatchWarningMessageTests()
    {
        _context = new FakeFrameworkMessageContext();
        _generator = new FrameworkVersionMismatchWarningMessage();
    }
    ...
    [Fact]
    public void Assembly_Test_False_BreakingStrongNamed()
    {
        var referenceA = AssHelp.Ass("ReferenceA");
        var referenceB = AssHelp.Ass("ReferenceB");
